    ...
    return (
      ...
      <div class="star-2"></div> 
        ...
        <Image src="/girl_sleeping.png" width={250} height={250} alt="girl sleeping"/>
          ...
          <h1>تصبحي على خير تصبحي على راحة تصبحي على سعادة تصبحي تصبحي على كل ما تتمني الله يحققلك كلشي بتتمنيه وان شاء الله يسعدك ودائما اشوف الفرح في وجهك وقلبك تصبحي على خير</h1>
        </div>
      </main>
    );
  }
